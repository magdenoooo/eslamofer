  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-teal-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-lg p-8 duration-300 animate-fade-in">
        <h1 className="text-4xl font-bold text-center text-teal-600 mb-12 animate-fade-in-up">
          سياسة الخصوصية – Eslamoffers.com
        </h1>

        <div className="text-right text-gray-700 space-y-8">
          <p className="text-lg mb-8 animate-fade-in-up delay-100">
            نحن في Eslamoffers.com نهتم بخصوصية زوارنا، ونوضح هنا كيف يتم جمع
            واستخدام المعلومات عند زيارتك لموقعنا.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 animate-fade-in-up delay-100">
              ...
              <ul className="space-y-3 text-gray-600">
                ...
                <li>
                  • قد نقوم بجمع البريد الإلكتروني فقط في حالة الاشتراك في
                  القائمة البريدية الخاصة بنا.
                </li>
            ...
            <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 animate-fade-in-up delay-200">
              ...
              <p className="text-gray-600">
                نحن ملتزمون بحماية معلوماتك وعدم استخدامها في أي شيء غير ما تم
                توضيحه في هذه السياسة.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 animate-fade-in-up delay-200">
              ...
              <p className="text-gray-600">
                قد نقوم بتحديث هذه السياسة من وقت لآخر، وسيتم نشر أي تعديل هنا
                على نفس الصفحة.
              </p>
            </div>
          </div>
          ...
          <div className="mt-12 text-center animate-fade-in-up delay-200">
            ...
            <p className="text-gray-600">
              لو عندك أي استفسار بخصوص سياسة الخصوصية، يمكنك التواصل معنا من
              خلال{' '}
              <a
                href="/contact"
                className="text-teal-600 hover:text-teal-700 underline transition-colors duration-300"
              >
                صفحة تواصل معنا
              </a>{' '}
              على الموقع.
